...
mapaBackground.src = "/assets/mapa1.png";
...
langostelvis.ataques.push(...CAPIPEPO_ATAQUES);
pydos.ataques.push(...RATIGUEYA_ATAQUES);
...
function unirseAlJuego() {
  fetch("http://192.168.0.139:8080/unirse").then((res) => {
    if (res.ok) {
...
function seleccionarMokepon(mascotaJugador) {
  fetch(`http://192.168.0.139:8080/mokepon/${jugadorId}`, {
    method: "post",
    headers: {
...
function enviarAtaques() {
  ...
  fetch(`http://192.168.0.139:8080/mokepon/${jugadorId}/ataques`, {
    method: "post",
    headers: {
      "Content-Type": "application/json",
    },
...
function obtenerAtaques() {
  ...
  fetch(`http://192.168.0.139:8080/mokepon/${enemigoId}/ataques`).then(
    function (res) {
      if (res.ok) {
...
function enviarPosicion(x, y) {
  fetch(`http://192.168.0.139:8080/mokepon/${jugadorId}/posicion`, {
    method: "post",
    headers: {
      "Content-Type": "application/json",
    },
